...
def diff_of_dicts(dict1, dict2):
    ...
    for key in all_keys:
        # про уровни вложенности крутила всяко, не вижу,
        # как можно сделать в один
        # по логике ключ в обоих словарях - значит другой иф на равность
        # можно сделать без второго вложенного иф,
        # но проверки будут двойными и длинными
        ...
        if key in dict1 and key in dict2:
            if dict1[key] == dict2[key]:
                ...
                # если они не равны, то мы еще не знаем,
                # где именно -> надо идти вглубь
                # зачем нам добавлять сюда ключи типа,
                # если при распаковке мы всё равно будем идти ниже?
